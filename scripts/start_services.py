#!/usr/bin/env python3
"""
Script to start Prefect server and Streamlit UI concurrently.
This script manages both services and provides a clean way to start/stop them.
"""
...
class ServiceManager:
    """Manages Prefect server, Prefect workers, Streamlit UI, and MLflow server processes."""
    ...
    def start_services(self):
        """Start Prefect server, Prefect workers, Streamlit UI, and MLflow server."""
        try:
            ...
            # Wait a bit for Prefect to initialize
            ...
            # Wait a bit for MLflow to initialize
...
def main():
    """Main entry point."""
    print("🚀 Trading System Service Manager")
    print("=" * 40)
